...
import Template1 from '../Final Resume Templates/Template1'
import Template2 from '../Final Resume Templates/Template2'
import Template3 from '../Final Resume Templates/Template3'
import Template4 from '../Final Resume Templates/Template4'
import html2canvas from 'html2canvas'
import SuccessMessage from './DownloadResumeMessage'
    ...
    return (
        ...
        <div  className=' row mt-2 p-5'>
            <div className='w-100 d-flex justify-content-center'>
                <Link to="/detailsfillingpage/Additionaldetails">
