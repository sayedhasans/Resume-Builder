...
function PersonalInfo(props) {
  ...
  return (
    <div style={{padding:"15px", textAlign:"left",}}>
        <div>
          ...
          <div className="row font">
              <div className="col-lg-6 col-12 pt-5 px-4">
                <div className='row '>
                  ...
                  <div className="col-sm-10  col-12">
                  <PhoneInput
                      defaultCountry="in"  elementId="Mobile" 
          ...
          <div className="row font">
              <div className="col-lg-6 col-12 pt-5 px-4">
                <div className='row '>
                  <div className='col-sm-2  col-12'>
                    <label htmlFor="inputCountry"className="col-sm-1 col-form-label" >Country</label>
                  </div>
                  <div className='col-sm-10  col-12'>
                    <select id="inputCountry" className="form-control" value={personalHeads.Country}
                            onChange={(e)=>{
                                dispatch(updatePersonalInfo({
                                  key: 'Country',
                                  value:e.target.value
          ...
          <div className="col-lg-6 col-12 pt-5  px-4">
                <div className='row'>
                  <div className='col-sm-2 col-12'>
                    <label htmlFor="linkedin" className="col-sm-1 col-form-label">Linkedin Profile</label>
                  </div>
                  <div className='col-sm-10 col-12'>
                    <TextField type="text" elementId="linkedin" value={personalHeads.LinkedIn} placeholder="https://www.linkedin.com"
                          onChange={(value)=>{ onChangeHandler('LinkedIn',value) }}
                    />
                  </div>
                </div>
              </div>
          ...
          <div className="col-lg-6 col-12 pt-5  px-4">
                <div className='row'>
                  <div className='col-sm-2 col-12'>
                    <label htmlFor="github" className="col-sm-1 col-form-label">Github Profile</label>
                  </div>
                  <div className='col-sm-10 col-12'>
                    <TextField type="text" elementId="github" value={personalHeads.Github} placeholder="https://github.com"
                          onChange={(value)=>{ onChangeHandler('Github',value) }}
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-12 col-12 pt-5 px-4">
                <div className='row '>
                  <div className='col-lg-1 col-sm-2 col-12'>
                    <label htmlFor="Textarea" className="col-sm-1 col-form-label">Summary</label>
                  </div>
        ...
        <BottomNavigation prevPagePath='/' nextPagePath='/detailsfillingpage/education' isFormValid={props.isFormValid}/>
