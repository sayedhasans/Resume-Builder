                            ...
                            <div className="row row-cols-2">
                              ...
                              <div className="col-sm-3 mt-4">
                                ...
                                <Link to={props.isFormValid?props.nextPagePath:'#'}>
                                  ...
                                  >
                                    {window.location.pathname === "/detailsfillingpage/Additionaldetails" //this condition changes the name of the 'next' button as 'preview' when the user reaches 'keySkills' page.
                                    ?'Preview'
                                    :'Next'}
                                  </button>
                                </Link>
